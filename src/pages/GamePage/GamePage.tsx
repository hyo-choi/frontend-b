...
import {
  GameOptionCard, Button, Dialog, Typo,
} from '~components/index';
import { GameWatchPage, GamePlayPage } from '~pages/index';
import {
  useAppState, useDialog, useGameDispatch, useGameState, useMatch,
} from '~hooks/index';
import { GameModeType, ReadyEventType } from '~types/index';
import { MAIN_GAME_PAGE, PLAY_PATH, WATCH_PATH } from '~constants/index';
